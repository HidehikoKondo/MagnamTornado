...
#pragma -mark AppleWatchから受け取ったメーッセージ
- (void)messageReceiveFromWatch: (NSString*) message{
    self.statusText.text = @"aaaaa";
    [self magnumTornado];
}
